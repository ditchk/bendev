  ...
  return (
    <section className="flex flex-col w-full h-full">
        ...
        <div className="flex justify-center w-full h-full mt-5">
          <Button className="custom-button animate-pulse" style={{background: "radial-gradient(25% 36.7838% at 93.425% 45.2022%, rgb(0, 153, 255) 0%, rgba(255, 255, 255, 0) 100%); filter: blur(10px); border-radius: 34.6179% / 181.9%; transform: translate3d(-2.44909px, 0px, 0px); transform-origin: 50% 50% 0px;"}}>Talk to me now! use the live chat!</Button>
        </div>
        </div>
