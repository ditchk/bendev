...
const IconDump = () => {
  return (
    <section className="flex flex-col w-full h-full my-4 mt-8">
      ...
      <h1 className="missionText">Crafting Digital Masterpieces, One Pixel at a Time</h1>
        ...
        <div className="grid grid-cols-6 justify-center items-center md:gap-0 gap-10 h-full w-screen opacity-70">
          <div>
