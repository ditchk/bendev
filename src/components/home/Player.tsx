...
const Player: React.FC<PlayerProps> = ({ src }) => {
  ...
  return (
    <div className="Player">
      ...
      <div className='flex xl:hidden justify-end mt-[22rem] md:mt-96 lg:mt-[35rem] xl:mt-[37.5rem] bg-white h-10 md:h-14 z-40 rounded-t-3xl w-screen absolute border-t-8 border-teal-800' />
