...
const Player: React.FC<PlayerProps> = ({ src }) => {
  ...
  return (
    <div className="Player">
      ...
      <div className='flex lg:hidden justify-end mt-[23.5rem] md:mt-96 bg-white h-10 md:h-14 z-40 rounded-t-3xl w-full absolute border-t-4 shadow-2xl shadow-black border-teal-100' />
