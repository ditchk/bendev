  ...
  return (
    <div className="packageSection" id="section">
        ...
        <div className="ContainerExplaPackage relative">
          ...
          {openContainer && (
            <div className="flex flex-col justify-center items-center bg-gradient-to-br from-black to-teal-500 rounded-2xl p-3 animate-in slide-in-from-bottom-10 top-16 duration-1000 ">
