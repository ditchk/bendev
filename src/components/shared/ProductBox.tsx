...
const ProductBox = ({ product } : ProductCardProps) => {
  ...
  return (
    ...
    ref={ref}
      ...
      <div className="flex flex-1 justify-start md:justify-center items-start md:items-center h-fit  p-3 rounded-t-xl">
        <div className="experience-container">
          <div className="flex flex-col justify-end w-full h-full p-5">
            <img src={product.imageUrl} loading='lazy' alt="webdesigner" width={300} className="rounded-bl-2xl rounded-tr-2xl"/>
          </div>
