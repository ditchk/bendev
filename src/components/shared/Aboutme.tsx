  ...
  return (
   <div className="flex flex-col justify-center gap-10 rounded-md p-5">
     <section className="flex flex-col justify-center w-full h-fit">
        ...
        >
            <h1 className="text-base md:text-xl text-white text-center text-bold font-bold">MY GOAL IN THE TECH INDUSTRY</h1>
            <p className="text-start md:text-center text-white font-sans font-light mx-5">As an ambitios young man its my obligation to make sure that i dont loose hope on my goals.<br /> 
    ...
    <section className="flex flex-col justify-center w-full h-fit">
        <div className="flex flex-col gap-5">
            <h1 className="text-center font-serif md:text-xl text-base font-bold text-white">MY DREAM AS A DEVELOPER</h1>
    ...
    <section className="flex flex-col justify-center w-full h-fit">
        <div className="flex flex-col">
            <h1 className="text-center text-base md:text-xl text-white font-bold font-serif">What are some of your created websites/Projects</h1>
            <p className="text-start text-base text-white md:text-center font-normal font-sans mx-5">Quite intresting that most of my projects are hosted locally. 
