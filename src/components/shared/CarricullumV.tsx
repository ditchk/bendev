...
const CarricullumV = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mx-2 md:mx-10 bg-opacity-5 outline outline-1 shadow-2xl outline-slate-200 my-5">
      ...
      <section id="roadmap" className="flex flex-1 w-full h-full outline outline-1 outline-slate-100 py-10 md:px-24 p-2">
        <div className="flex flex-col justify-start items-start">
            ...
            <p className="text-xs sm:text-xs md:text-base p-1 md:p-5 rounded-sm font-normal font-sans mb-5">
      ...
      <section id="qualify" className="flex flex-1 w-full h-full py-10 md:px-24 p-3">
        <div className="flex flex-col justify-start items-start">
            ...
            <p className="text-xs md:ml-5 sm:text-xs md:text-base p-1 md:p-10 rounded-sm font-normal font-sans mb-5">
      ...
      <section className="flex flex-col w-full h-fit py-10 md:px-24 p-5 outline outline-1 outline-slate-50">
        <div className="flex flex-col justify-start items-start">
            ...
            <p className="text-xs md:ml-5 sm:text-xs md:text-base p-1 md:p-5 rounded-sm font-normal font-sans mb-5">
