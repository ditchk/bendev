...
import { SiAdobe, SiAppwrite, SiAwsamplify, SiAzuredevops, SiBlender, SiFramer, SiGamedeveloper, SiGit, SiGoogleads, SiGooglecloud, SiIbmwatson, SiMicrosoft, SiMicrosoftazure, SiMongodb, SiPostgresql} from "react-icons/si";
