    ...
    <section className="flex flex-col justify-center items-center my-10">
      <div className="flex felx-1 justify-start md:justify-center items-start md:items-center h-fit  p-5 rounded-t-xl">
        <div className="experience-container">
          ...
          <div className="flex flex-col justify-start items-start w-full h-full md:p-5 p-3 outline outline-1 outline-slate-100 bg-cyan-950 bg-opacity-10 md:rounded-e-full">
