...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col shadow shadow-slate-600 mt-24 bg-gradient-to-l from-cyan-200 via-neutral-50 to-teal-50">
      <div className="flex flex-col md:flex-row justify-between gap-5 m-10 p-10 items-center shadow-inner shadow-gray-400 rounded-lg outline outline-2 outline-cyan-300 bottom-0 sticky">
          <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-row gap-3 space-y-8 w-fit p-5">
            <FormField
      ...
      <div className="flex flex-1 justify-center items-center border-t border-slate-300 shadow shadow-slate-500 backdrop-blur-sm sticky bottom-0 backdrop-blur-sm">
