...
const Navbar = () => {
  ...
  return (
    <nav id='navbar' className={`navbar bg-white backdrop-blur-sm rounded-2xl shadow-md shadow-gray-400 my-2 left-[3.5px] md:left-[10px] lg:left-[14px]  ${scrollDirection === 'down' ? 'hide shadow-none' : ''}`}>
      <Link 
      to={'/'}
