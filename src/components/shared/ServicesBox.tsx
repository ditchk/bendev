...
const ServicesBox = ({service} : ServiceBoxProps ) => {
  ...
  return (
    ...
    style={{
      ...
      ref={ref}
    className="flex flex-col justify-center h-full w-full items-center p-5">
        <div className="flex flex-col bg-cyan-950 bg-opacity-10 relative outline-1 outline outline-slate-100 p-2 min-h-[450px] rounded-tr-3xl">
            <img src={service.imageUrl} loading="lazy" alt={"project Management"} className=" w-auto h-60 rounded-tr-3xl overflow-hidden rounded-bl-3xl"/>
