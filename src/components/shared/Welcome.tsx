                    ...
                    <li key={link.title}>
                      <h1 className="tittl_name">{link.title}</h1>
                        ...
                        <div className="flex flex-row justify-center items-center mt-5 animate-in slide-in-from-bottom-20 duration-700 m-1">
                          ...
                          <div className="flex w-[25px] md:w-[35px] justify-center rounded-full bg-transparent outline outline-2 outline-slate-300 shadow-md shadow-slate-500 h-[20px] md:h-[25px] animate-spin" />
                        </div>
                      <div className="flex flex-row justify-center items-center mt-5 animate-in slide-in-from-bottom-40 duration-700 m-1">
                        <div className="flex w-[25px] md:w-[35px] justify-center rounded-full bg-transparent outline outline-2 outline-slate-300 shadow-md shadow-slate-500 h-[20px] md:h-[25px] animate-spin direction-alternate-reverse" />
                      ...
                      <div className="flex flex-row justify-center items-center mt-5 animate-in slide-in-from-bottom-20 duration-700 m-1">
                          ...
                          <div className="flex w-14 sm:w-72 justify-center bg-slate-300 h-[2px]" />
                          <div className="flex w-[25px] md:w-[35px] justify-center rounded-full bg-transparent outline outline-2 outline-slate-300 shadow-md shadow-slate-500 h-[20px] md:h-[25px] animate-spin direction-reverse" />
                        </div>
                        <Skills />
                    </li>
                      <img 
