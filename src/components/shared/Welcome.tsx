              ...
              <div className="flex flex-col md:flex-row w-fit gap-5 md:gap-0 md:p-5 animate-in slide-in-from-up-40 duration-500 overflow-hidden">
                  <li key={link.title} >
                    <h1 className="tittl_name">{link.title}</h1>
                      ...
                      <div className="flex w-[25px]  shadow-sm shadow-slate-400 md:w-[35px] justify-center rounded-full bg-gradient-to-tl from-cyan-950 to-cyan-200 outline outline-1 outline-white h-[25px]" />
                      </div>
                    ...
                    <div className="flex w-20 sm:w-72  shadow-sm shadow-slate-400 justify-center bg-white h-[1px]" />
                        ...
                        />
                        <div className="flex absolute w-[1px] shadow-xl shadow-slate-400 justify-center bg-white h-98" /> 
                    </div> 
                    <div className="flex flex-row justify-center items-center mt-5">
                      <div className="flex w-[25px]  shadow-sm shadow-slate-400 md:w-[35px] justify-center rounded-full bg-gradient-to-tl from-cyan-950 to-cyan-200 outline outline-1 outline-white h-[25px]" />
                      <div className="flex w-20 sm:w-72  shadow-sm shadow-slate-400 justify-center bg-white h-[1px]" />
