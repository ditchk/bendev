...
const Sidebar = () => {
  ...
  return (
    <nav className="hidden md:flex flex-row justify-between items-center mt-3 px-5 py-5 bg-white h-fit outline sticky top-0 w-full outline-1 outline-slate-300">
