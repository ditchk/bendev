  ...
  return (
    <div>
      ...
      <motion.form
        ...
        className="flex flex-col justify-start items-center h-fit p-3 md:px-16 shadow-lg py-8 shadow-cyan-950 bg-cyan-950 bg-opacity-10 w-auto space-y-3 rounded-md outline outline-1 outline-slate-200">
