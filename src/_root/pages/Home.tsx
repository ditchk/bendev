            ...
            return (
              <div className="flex flex-col md:flex-row w-fit gap-5 md:gap-0">
                  <li key={link.title} >
                    ...
                    <h3 className="paragraph_text">I have aquired skills that will help your business scale up in this technology era.Using my expertise i will design stunning <br /> for your busines using the latest technology <br /> Click the button below to talk to me (❁´◡`❁)</h3>
